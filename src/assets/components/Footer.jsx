    ...
    <footer className="bg-slate-950 px-4 py-10 text-white">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-10 md:grid-cols-3">
          {/* ================= LOGO / DESCRIPTION ================= */}
          <div>
            <NavLink to="/" className="inline-block text-2xl font-black">
              Poke<span className="text-red-500">Dex</span>
            </NavLink>

            <p className="mt-3 max-w-sm text-sm leading-6 text-slate-400">
              Explore Pokémon, discover their abilities, learn about their types
        ...
        <div className="mt-10 border-t border-slate-800 pt-6 text-center text-sm text-slate-500">
          © <span className="mr-2">{newYear}</span> PokeDex. Built with React &
          Tailwind CSS By <span className="">{developerName}</span>.
        </div>
      </div>
    </footer>
  );
